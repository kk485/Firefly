...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://blog.baiym.top",

	// 站点描述
	description:
		"欢迎来到我的世界！这里是残梦断忆的博客空间，记录着我的点滴生活、技术探索和创作分享。希望你能在这里找到有趣的内容，感受到我的热情与思考。",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/weblogo.webp",
			valueDark: "assets/images/weblogo.webp", // 如果你有暗色版logo就写，没有就留空或指回同一个
			alt: "Logo",
		},
		// 导航栏标题
		title: "Dreamshard",
